        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-[#11151E] border border-white/8">
                <div className="flex items-center space-x-2 text-[#2DD4BF] font-semibold text-sm mb-1.5">
          ...
          <div className="lg:col-span-5 p-6 rounded-2xl bg-[#11151E] border border-white/12 shadow-2xl relative overflow-hidden">
            <div className="text-xs font-mono uppercase tracking-wider text-[#7D8595] pb-3 border-b border-white/8 flex items-center justify-between">
              ...
              <span className="text-[#2DD4BF]">Karachi • PK</span>
            </div>
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="flex items-start space-x-3 p-3 rounded-xl bg-[#161C28] border border-[#2DD4BF]/30">
                <div className="w-6 h-6 rounded-full bg-[#2DD4BF]/20 text-[#2DD4BF] flex items-center justify-center font-mono text-xs font-bold flex-shrink-0 mt-0.5">
                  ✓
                </div>
                <div>
                  <h4 className="text-xs font-bold text-[#2DD4BF] uppercase tracking-wider">The Daniyal Approach</h4>
              ...
              <div className="pt-2 space-y-2 text-xs font-mono text-[#B5BBC7]">
                <div className="flex items-center justify-between py-1 border-b border-white/5">
                  ...
                  <span className="text-[#2DD4BF]">100% Crawlable</span>
                </div>
                <div className="flex items-center justify-between py-1 border-b border-white/5">
