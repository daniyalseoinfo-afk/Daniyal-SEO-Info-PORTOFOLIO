      ...
      <div className="relative w-full max-w-2xl bg-[#11151E] border border-white/14 rounded-3xl p-6 sm:p-8 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] max-h-[90vh] overflow-y-auto">
        ...
        {isSubmitted ? (
          <div className="py-12 text-center space-y-4">
            <div className="w-16 h-16 rounded-full bg-[#2DD4BF]/20 border border-[#2DD4BF] text-[#2DD4BF] flex items-center justify-center mx-auto">
            ...
            <p className="text-sm text-[#B5BBC7] max-w-md mx-auto leading-relaxed">
              Thank you, <strong className="text-white">{formData.fullName}</strong>. I will personally review your website (<span className="text-[#2DD4BF] font-mono">{formData.websiteUrl}</span>) for technical crawl bottlenecks, indexing, and keyword gaps, and get back to you via email within 24 hours.
            </p>
            <div className="pt-4">
              <button
                onClick={handleReset}
                className="px-6 py-3 rounded-xl bg-[#2DD4BF] text-[#080A0F] font-bold text-sm hover:bg-[#14B8A6] transition-colors"
              >
                Close Window
              </button>
            </div>
          ...
          <div>
            ...
            <div className="mb-6 space-y-1">
              <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded bg-[#2DD4BF]/10 border border-[#2DD4BF]/20 text-[11px] font-mono text-[#2DD4BF]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#161C28] border border-white/10 text-white placeholder-[#7D8595] text-sm focus:outline-none focus:border-[#2DD4BF]"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#161C28] border border-white/10 text-white text-sm focus:outline-none focus:border-[#2DD4BF]"
                  >
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-[#2DD4BF] text-[#080A0F] font-bold text-sm sm:text-base hover:bg-[#14B8A6] transition-all flex items-center justify-center space-x-2 shadow-[0_0_25px_-5px_rgba(45,212,191,0.4)] disabled:opacity-50"
                >
                  {isSubmitting ? (
