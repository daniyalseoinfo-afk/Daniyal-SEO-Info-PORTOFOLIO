...
export const FinalCtaSection: React.FC<FinalCtaSectionProps> = ({
  ...
  return (
    <section id="final-cta" className="py-24 sm:py-32 bg-[#0D1017] relative border-t border-white/8 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-96 bg-[#2DD4BF]/12 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        {/* Small Eyebrow */}
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#11151E] border border-[#2DD4BF]/30 text-xs font-mono text-[#2DD4BF] mb-6">
        ...
        <h2 className="text-4xl sm:text-6xl font-extrabold text-[#F7F8FA] tracking-tight font-display max-w-3xl mx-auto leading-[1.1]">
          ...
          <span className="text-[#2DD4BF]">missing.</span>
        </h2>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <button
            ...
            className="px-8 py-4 rounded-2xl bg-[#2DD4BF] text-[#080A0F] font-bold text-base hover:bg-[#14B8A6] transition-all transform hover:-translate-y-0.5 shadow-[0_0_35px_-5px_rgba(45,212,191,0.5)] flex items-center space-x-2 active:translate-y-0"
            data-cursor="AUDIT"
          >
          ...
          >
            ...
            <ArrowUpRight className="w-5 h-5 text-[#2DD4BF]" />
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-xs font-mono text-[#2DD4BF] uppercase tracking-wider">
            ...
            <div className="pt-2 flex items-center space-x-3 text-xs font-mono">
              <a
                ...
                className="text-[#B5BBC7] hover:text-[#2DD4BF] transition-colors flex items-center space-x-1"
              >
