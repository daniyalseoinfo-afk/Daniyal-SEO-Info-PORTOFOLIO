      ...
      {selectedPost ? (
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-in fade-in duration-200">
          <button
            ...
            className="inline-flex items-center space-x-2 text-xs font-mono text-[#B7FF3C] hover:underline mb-8"
          >
          ...
          <div className="space-y-4 pb-8 border-b border-white/10">
            <span className="text-xs font-mono px-3 py-1 rounded bg-[#11151E] text-[#B7FF3C] border border-[#B7FF3C]/30">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-[#7D8595]">
              <span className="flex items-center space-x-1">
                <User className="w-3.5 h-3.5 text-[#B7FF3C]" />
          ...
          <div className="my-8 p-6 rounded-2xl bg-[#11151E] border border-white/8">
            <h4 className="text-xs font-mono uppercase tracking-widest text-[#B7FF3C] font-bold mb-3">
              Table of Contents
            </h4>
          ...
          <div className="mt-12 p-8 rounded-3xl bg-[#11151E] border border-white/12 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-[#B7FF3C] text-[#080A0F] font-bold text-xs sm:text-sm hover:bg-[#A8F536] flex-shrink-0"
            >
              Request Free Audit
            </button>
          </div>
                  ...
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-xs font-mono transition-all ${
                        activeCategory === cat
                          ? 'bg-[#B7FF3C] text-[#080A0F] font-bold shadow-md'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredPosts.map((post) => (
                  <div
                    key={post.id}
                    className="p-8 rounded-3xl bg-[#11151E] border border-white/8 hover:border-[#B7FF3C]/40 transition-all flex flex-col justify-between group cursor-pointer"
                    onClick={() => setSelectedPost(post)}
                  >
                    <div className="space-y-4">
                      <div className="flex items-center justify-between text-xs font-mono text-[#7D8595]">
                        <span className="px-2 py-0.5 rounded bg-[#161C28] text-[#B7FF3C]">
                          {post.category}
                        </span>
                        <span>{post.readTime}</span>
                      </div>

                      <h3 className="text-xl font-bold text-white group-hover:text-[#B7FF3C] transition-colors leading-snug">
                        {post.title}
                      </h3>
                    ...
                    <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs font-mono">
                      ...
                      <span className="text-[#B7FF3C] group-hover:underline flex items-center space-x-1 font-bold">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 bg-[#11151E] p-8 sm:p-10 rounded-3xl border border-white/10 shadow-2xl">
              {submitted ? (
                <div className="py-16 text-center space-y-4">
                  <div className="w-16 h-16 rounded-full bg-[#B7FF3C]/20 border border-[#B7FF3C] text-[#B7FF3C] flex items-center justify-center mx-auto text-2xl font-bold">
                    ✓
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-[#161C28] border border-white/10 text-white placeholder-[#7D8595] text-sm focus:border-[#B7FF3C]"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-[#161C28] border border-white/10 text-white text-sm focus:border-[#B7FF3C]"
                      >
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="p-6 rounded-3xl bg-[#11151E] border border-white/8 space-y-4">
                <span className="text-xs font-mono uppercase tracking-wider text-[#B7FF3C]">DIRECT CONTACT</span>
                
                <div className="space-y-3 text-xs sm:text-sm">
                  <div>
                    <span className="text-[#7D8595] block font-mono">Email Address:</span>
                    <a href="mailto:daniyalseoinfo@gmail.com" className="text-white font-medium hover:text-[#B7FF3C]">
                  ...
                  <div>
                    ...
                    <span className="text-[#B7FF3C] font-semibold">Accepting Select SEO Projects</span>
                  </div>
                </div>
              </div>
