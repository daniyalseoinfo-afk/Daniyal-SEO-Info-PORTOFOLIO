...
export const SearchIntelligence3D: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#B7FF3C]/12 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      >
        ...
        <div className="absolute -top-4 -left-3 sm:-top-6 sm:-left-6 z-20 px-3.5 py-1.5 rounded-full bg-[#11151E]/90 border border-[#B7FF3C]/40 backdrop-blur-xl shadow-xl flex items-center space-x-2 animate-bounce duration-1000">
          ...
          <span className="text-[11px] font-mono font-bold text-white tracking-tight">
            Position ↑ <span className="text-[#B7FF3C]">+38% Clicks</span>
          </span>
        </div>
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-[#0D1017]/90 border border-white/12 backdrop-blur-2xl p-4 sm:p-6 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.85)] relative overflow-hidden">
          ...
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/8">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-white/5 text-[#B7FF3C] border border-[#B7FF3C]/20">
                SERP LIVE
              </span>
            </div>
          </div>
          ...
          <div className="relative mb-5">
            <div className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-[#161C28] border border-white/12 text-sm focus-within:border-[#B7FF3C] transition-colors">
              <div className="flex items-center space-x-2.5 overflow-hidden">
                <Search className="w-4 h-4 text-[#B7FF3C] flex-shrink-0" />
              ...
              <span className="w-1.5 h-4 bg-[#B7FF3C] animate-pulse" />
            </div>
              ...
              {queries.map((q, i) => (
                <button
                  ...
                  className={`text-[9px] font-mono px-2 py-0.5 rounded-md whitespace-nowrap transition-all ${
                    activeQueryIndex === i
                      ? 'bg-[#B7FF3C]/20 text-[#B7FF3C] border border-[#B7FF3C]/40 font-semibold'
          ...
          <div className="space-y-3">
            ...
            <div className="p-3.5 rounded-xl bg-[#11151E] border border-[#B7FF3C]/30 hover:border-[#B7FF3C] transition-all group">
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center space-x-1.5">
                  <div className="w-4 h-4 rounded-full bg-[#B7FF3C]/20 flex items-center justify-center">
                    <Globe className="w-2.5 h-2.5 text-[#B7FF3C]" />
                  </div>
                  <span className="text-[10px] font-mono text-[#B5BBC7]">daniyalseo.pk/karachi</span>
                </div>
                <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-[#B7FF3C] text-[#080A0F] font-bold">
                  #1 ORGANIC
                </span>
              </div>
              <h4 className="text-sm font-semibold text-[#B7FF3C] group-hover:underline flex items-center">
            ...
            <div className="p-2.5 rounded-xl bg-[#121722]/50 border border-white/5 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 text-[10px] font-mono">
                <span className="text-[#B7FF3C]">CTR 8.4%</span>
          ...
          <div className="mt-4 pt-3 border-t border-white/8 flex items-center justify-between text-[10px] font-mono text-[#7D8595]">
            <span className="flex items-center space-x-1">
              <Sparkles className="w-3 h-3 text-[#B7FF3C]" />
