    ...
    >
      <div
        className={`rounded-full flex items-center justify-center transition-all duration-200 ${
          isHovered
            ? 'w-10 h-10 bg-[#B7FF3C]/20 border border-[#B7FF3C] backdrop-blur-[2px]'
            : 'w-3 h-3 bg-[#B7FF3C] shadow-[0_0_12px_#B7FF3C]'
        }`}
      >
        {hoverText && (
          <span className="text-[9px] font-mono font-bold text-[#B7FF3C] tracking-tighter uppercase">
            {hoverText}
          </span>
        )}
      </div>
