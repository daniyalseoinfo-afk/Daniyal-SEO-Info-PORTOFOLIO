      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[#F7F8FA] tracking-tight font-display leading-tight">
            ...
            <span className="text-[#B7FF3C]">actually needs.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div
            ...
            className="lg:col-span-8 rounded-3xl bg-[#0D1017] border border-white/10 hover:border-[#B7FF3C]/50 transition-all p-6 sm:p-8 flex flex-col justify-between group relative overflow-hidden"
          >
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-3">
                <span className="text-2xl font-mono font-bold text-[#B7FF3C]">01</span>
              ...
              <button
                ...
                className="p-2.5 rounded-full bg-[#161C28] text-white group-hover:bg-[#B7FF3C] group-hover:text-[#080A0F] transition-all transform group-hover:translate-x-1"
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
              <div className="md:col-span-6 space-y-3">
                <h3 className="text-2xl font-bold text-white group-hover:text-[#B7FF3C] transition-colors">
                  Technical SEO
                </h3>
                ...
                <div className="pt-2">
                  <button
                    onClick={() => onRouteChange('technical-seo-services-karachi')}
                    className="text-xs font-mono font-bold text-[#B7FF3C] hover:underline flex items-center space-x-1"
                  >
              ...
              <div className="md:col-span-6 p-4 rounded-2xl bg-[#11151E] border border-white/8 relative">
                <div className="text-[10px] font-mono text-[#7D8595] pb-2 mb-3 border-b border-white/5 flex items-center justify-between">
                  ...
                  <span className="text-[#B7FF3C] font-semibold">200 OK Active</span>
                </div>
                ...
                <div className="space-y-2 font-mono text-xs">
                  ...
                  <div
                    ...
                    className={`p-2 rounded-lg border transition-all flex items-center justify-between ${
                      hoveredNode === 'root' ? 'bg-[#B7FF3C]/15 border-[#B7FF3C]' : 'bg-[#161C28] border-white/5'
                    }`}
                  >
                    <span className="text-[#B7FF3C] font-bold">/ (Homepage)</span>
                    <span className="text-[10px] text-[#7D8595]">Depth: 0 • 200 OK</span>
                  </div>

                  {/* Branch Level 1 */}
                  <div className="pl-4 space-y-1.5 border-l-2 border-dashed border-[#B7FF3C]/30 ml-3">
                    <div
                    ...
                    >
                      ...
                      <span className="text-[9px] text-[#B7FF3C]">Canonical ✓</span>
                    </div>
                ...
                <div className="text-xs font-mono p-2.5 rounded-lg bg-[#161C28] border border-white/5 text-white">
                  {activeTab === 'title' && (
                    <div>
                      ...
                      <span className="text-[#B7FF3C]">SEO Services in Karachi | Daniyal</span>
                      <span className="text-[#45E6FF]">&lt;/title&gt;</span>
                  ...
                  {activeTab === 'link' && (
                    <div>
                      ...
                      <span className="text-[#B7FF3C]">Request an SEO Review</span>
          ...
          <div
            ...
            className="lg:col-span-7 rounded-3xl bg-[#0D1017] border border-white/10 hover:border-[#B7FF3C]/50 transition-all p-6 sm:p-8 flex flex-col justify-between group relative overflow-hidden"
          >
            <div>
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-3">
                  <span className="text-2xl font-mono font-bold text-[#B7FF3C]">03</span>
                  <span className="text-xs font-mono uppercase tracking-widest text-[#7D8595] px-2 py-0.5 rounded bg-white/5">
                    Query Strategy
                  </span>
                </div>
              ...
              <div className="p-4 rounded-2xl bg-[#11151E] border border-white/8 space-y-2">
                <div className="text-[10px] font-mono text-[#7D8595] pb-1 border-b border-white/5 flex items-center justify-between">
                  ...
                  <span className="text-[#B7FF3C]">Intent Mapped</span>
                </div>

                <div className="grid grid-cols-2 gap-2 pt-1">
                  <div className="p-2 rounded-xl bg-[#161C28] border border-[#B7FF3C]/30 text-xs">
                    <span className="text-[10px] font-mono uppercase text-[#B7FF3C] block font-bold">Commercial Intent</span>
              ...
              <div className="p-4 rounded-2xl bg-[#11151E] border border-white/8 relative">
                <div className="flex items-center justify-between text-[10px] font-mono text-[#7D8595] pb-2 mb-3 border-b border-white/5">
                  <span className="flex items-center space-x-1">
                    <MapPin className="w-3 h-3 text-[#B7FF3C]" />
                    <span>KARACHI LOCAL PACK</span>
                  </span>
                  <span className="text-[#45E6FF]">3-Pack Ranking</span>
                </div>

                <div className="p-3 rounded-xl bg-[#161C28] border border-[#B7FF3C]/30 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-white">Google Business Profile</span>
                    <span className="text-[10px] font-mono text-[#B7FF3C] bg-[#B7FF3C]/10 px-1.5 py-0.5 rounded">
                      Verified
                    </span>
                  </div>
