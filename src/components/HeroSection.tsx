...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="hero" className="relative min-h-[90vh] flex flex-col justify-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-96 h-96 bg-[#B7FF3C]/8 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#F7F8FA] leading-[1.08] font-display">
              SEO that turns{' '}
              <span className="text-[#B7FF3C] underline decoration-[#B7FF3C]/40 decoration-wavy underline-offset-8">
                search data
              </span>{' '}
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#B7FF3C] text-[#080A0F] font-bold text-sm sm:text-base hover:bg-[#A8F536] transition-all transform hover:-translate-y-0.5 shadow-[0_0_25px_-5px_rgba(183,255,60,0.4)] flex items-center space-x-2 active:translate-y-0"
              ...
              <button
                ...
                className="px-4 py-3.5 rounded-xl text-xs sm:text-sm font-mono text-[#B7FF3C] hover:underline flex items-center space-x-1"
              >
        ...
        <div className="mt-16 sm:mt-24 pt-6 border-t border-white/5 flex items-center justify-between text-xs font-mono text-[#7D8595]">
          <div className="flex items-center space-x-3">
            <span className="text-[#B7FF3C] font-bold">01</span>
            <span className="uppercase tracking-widest">SCROLL TO EXPLORE</span>
            <span className="w-8 h-[1px] bg-[#B7FF3C]/40 animate-pulse" />
          </div>
