      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[#F7F8FA] tracking-tight font-display">
            ...
            <span className="text-[#B7FF3C]">Hands-on SEO.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {principles.map((p) => {
            ...
            return (
              <div
                key={p.num}
                className="p-8 rounded-3xl bg-[#11151E] border border-white/8 hover:border-[#B7FF3C]/40 transition-all group relative overflow-hidden"
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-[#161C28] border border-white/8 flex items-center justify-center text-[#B7FF3C] group-hover:bg-[#B7FF3C] group-hover:text-[#080A0F] transition-colors">
                    <Icon className="w-6 h-6" />
                  </div>
                  <span className="text-2xl font-mono font-bold text-[#7D8595] group-hover:text-[#B7FF3C] transition-colors">
                    {p.num}
                  </span>
                </div>

                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#B7FF3C] transition-colors">
                  {p.title}
                </h3>
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all overflow-hidden ${
                  isOpen
                    ? 'bg-[#11151E] border-[#B7FF3C]/40 shadow-lg'
              ...
              >
                ...
                >
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${
                    isOpen ? 'bg-[#B7FF3C] text-[#080A0F]' : 'bg-[#161C28] text-white'
                  }`}>
