        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              data-cursor="HOME"
            >
              <div className="w-8 h-8 rounded-lg bg-[#121722] border border-white/10 flex items-center justify-center group-hover:border-[#2DD4BF] transition-colors">
                <span className="font-mono text-sm font-bold text-[#2DD4BF]">D</span>
              </div>
              <div>
                <span className="font-display font-extrabold text-lg sm:text-xl tracking-tight text-white group-hover:text-[#2DD4BF] transition-colors">
                  DANIYAL<span className="text-[#2DD4BF]">.</span>
                </span>
          ...
          <nav className="hidden lg:flex items-center space-x-1" aria-label="Main Navigation">
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${isServicesDropdownOpen ? 'rotate-180 text-[#2DD4BF]' : ''}`} />
              </button>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left p-2.5 rounded-xl transition-all flex items-start space-x-3 group ${
                            isActive ? 'bg-[#2DD4BF]/10 border border-[#2DD4BF]/30' : 'hover:bg-white/5'
                          }`}
                        >
                          <div className="p-2 rounded-lg bg-[#161C28] border border-white/8 text-[#2DD4BF] group-hover:bg-[#2DD4BF] group-hover:text-[#080A0F] transition-colors mt-0.5">
          ...
          <div className="hidden sm:flex items-center space-x-3">
            <button
              ...
              className="relative group px-4 py-2.5 rounded-xl bg-[#2DD4BF] text-[#080A0F] text-xs sm:text-sm font-bold flex items-center space-x-1.5 hover:bg-[#14B8A6] transition-all transform hover:-translate-y-0.5 shadow-[0_0_20px_-3px_rgba(45,212,191,0.35)] active:translate-y-0"
              data-cursor="AUDIT"
            >
          ...
          <div className="flex sm:hidden items-center space-x-2">
            <button
              ...
              onClick={onRequestReview}
              className="px-3 py-1.5 rounded-lg bg-[#2DD4BF] text-[#080A0F] text-xs font-bold"
            >
              Review
            </button>
            <button
              ...
              className="p-2 rounded-xl bg-[#121722] border border-white/10 text-white hover:text-[#2DD4BF]"
        ...
        <div className="fixed inset-0 top-[60px] bg-[#080A0F]/95 backdrop-blur-2xl z-50 p-6 flex flex-col justify-between overflow-y-auto lg:hidden">
          <div className="space-y-6">
            <div className="border-b border-white/10 pb-4">
              <span className="text-xs font-mono text-[#2DD4BF] uppercase tracking-widest">Navigation</span>
            </div>
                ...
                <button
                  ...
                  className={`flex items-center justify-between text-left py-2.5 px-3 rounded-xl transition-all ${
                    currentRoute === item.route
                      ...
                      : 'text-[#F7F8FA] hover:text-[#2DD4BF] hover:bg-white/5'
                  }`}
                >
              ...
              <div className="grid grid-cols-2 gap-2">
                {serviceSubItems.map((sub) => (
                  <button
                    ...
                    className="p-3 text-left rounded-xl bg-[#11151E] border border-white/8 hover:border-[#2DD4BF]/50 transition-colors"
                  >
          ...
          <div className="pt-6 border-t border-white/10 mt-6 space-y-3">
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[#2DD4BF] text-[#080A0F] font-bold text-center flex items-center justify-center space-x-2"
            >
