      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className="absolute inset-0 bg-[#2DD4BF]/10 rounded-3xl blur-3xl -z-10" />
            ...
            <div className="relative w-full max-w-sm sm:max-w-md">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/14 shadow-[0_20px_50px_rgba(0,0,0,0.8)] bg-[#11151E]">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-3 rounded-xl bg-[#0D1017]/80 backdrop-blur-md border border-white/10 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-[10px] font-mono text-[#2DD4BF]">Junior SEO Executive</span>
                  </div>
              ...
              <div className="absolute -top-3 -right-3 sm:-top-5 sm:-right-5 px-3 py-1.5 rounded-full bg-[#11151E] border border-[#2DD4BF]/40 backdrop-blur-xl shadow-lg flex items-center space-x-1.5 text-xs font-mono font-semibold text-white">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3 rounded-xl bg-[#0D1017] border border-white/8 text-xs">
                <span className="font-mono text-[#2DD4BF] block font-bold mb-1">01. Direct Execution</span>
            ...
            <div className="pt-4 flex items-center space-x-4">
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#11151E] border border-white/15 text-white font-semibold text-sm hover:bg-[#161C28] hover:border-[#2DD4BF]/50 transition-all flex items-center space-x-2"
                data-cursor="ABOUT"
              >
              ...
              <button
                ...
                className="text-xs sm:text-sm font-mono text-[#B5BBC7] hover:text-[#2DD4BF] underline underline-offset-4"
              >
                Get In Touch →
              </button>
            </div>
