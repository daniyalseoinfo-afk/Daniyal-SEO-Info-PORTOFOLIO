  ...
  return (
    <div className="pt-28 pb-20">
      ...
      <section className="py-16 sm:py-24 bg-[#080A0F] relative border-b border-white/8">
        <div className="absolute top-1/3 left-10 w-96 h-96 bg-[#2DD4BF]/8 rounded-full blur-3xl pointer-events-none -z-10" />
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#2DD4BF] text-[#080A0F] font-bold text-sm hover:bg-[#14B8A6] transition-all shadow-[0_0_25px_-5px_rgba(45,212,191,0.4)] flex items-center space-x-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {SERVICES_LIST.map((svc) => (
              <div
                key={svc.id}
                className="p-8 rounded-3xl bg-[#11151E] border border-white/8 hover:border-[#2DD4BF]/40 transition-all flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-mono text-[#2DD4BF] px-2.5 py-1 rounded bg-[#161C28] border border-white/5">
                      SERVICE {svc.number}
                    </span>
                    <button
                      onClick={() => onRouteChange(svc.route)}
                      className="text-xs font-mono text-[#7D8595] group-hover:text-[#2DD4BF] flex items-center space-x-1"
                    >
                      <span>Deep Dive</span>
                ...
                <div className="mt-6 pt-4 border-t border-white/5">
                  <button
                    onClick={() => onRouteChange(svc.route)}
                    className="text-xs font-mono font-bold text-white group-hover:text-[#2DD4BF] flex items-center space-x-1"
                  >
      ...
      <section className="py-20 bg-[#0D1017] border-t border-b border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            <span className="text-xs font-mono uppercase tracking-widest text-[#2DD4BF]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={ind.title} className="p-6 rounded-2xl bg-[#11151E] border border-white/8 space-y-3">
                <span className="text-[10px] font-mono text-[#2DD4BF] bg-white/5 px-2 py-0.5 rounded">
                  {ind.area}
                </span>
      ...
      <section className="py-16 bg-[#0D1017] border-t border-white/8 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="mt-6 flex justify-center gap-4">
            <button
              onClick={() => onRequestReview()}
              className="px-6 py-3.5 rounded-xl bg-[#2DD4BF] text-[#080A0F] font-bold text-sm hover:bg-[#14B8A6] transition-colors"
            >
